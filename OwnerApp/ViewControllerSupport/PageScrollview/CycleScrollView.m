...
- (MyPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            UIImage *normalDotImage = [UIImage imageNamed:@"Rectangle2"];
            CGFloat pageControlWidth = totalPageCounts * normalDotImage.size.width + (totalPageCounts - 1) * dotGapWidth;
            CGRect pageControlFrame = CGRectMake(CGRectGetMidX(self.scrollView.frame) - 0.5 * pageControlWidth + 100 , 0.9 * CGRectGetHeight(self.scrollView.frame), pageControlWidth, normalDotImage.size.height);
            ...
            _pageControl = [[MyPageControl alloc] initWithFrame:pageControlFrame
                                               ...
                                               highlightedImage:[UIImage imageNamed:@"Rectangle-1"]
...
//        SLog(@"UIGestureRecognizerStateBegan");
        [self.animationTimer pauseTimer];
    }
